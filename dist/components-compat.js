  ...
  function applyvideoID(component) {
    ...
    if (component.videoID && component.videoID != '') {
      ...
      window.onYouTubeIframeAPIReady = function () {
        var player = new YT.Player(videoBox, {
...
/***/function (module, exports, __webpack_require__) {
  ...
  module.exports = "<style>" + __webpack_require__(7) + "</style> <div class=\"image-wrapper\"> <img class=\"hidden-image\" id=\"hidden-image\"> <div class=\"tv\"> <div id=\"player\" class=\"screen mute\"></div> </div> </div> <div class=\"text-wrapper\"> <div class=\"text-inner-wrapper\"> <div class=\"headline slot-wrapper\"> <slot id=\"headline\" name=\"headline\"></slot> </div> <div class=\"intro-text slot-wrapper\"> <slot id=\"intro-text\" name=\"intro-text\"></slot> </div> <div class=\"read-more-link slot-wrapper\"> <slot id=\"read-more\" name=\"read-more\"></slot> </div> </div> </div>";
