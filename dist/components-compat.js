...
/***/function (module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.i, "/*!\n *  @license\n *    Copyright 2017 Brigham Young University\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n */\n/*!\n *  @license\n *    Copyright 2017 Brigham Young University\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n */:host{width:100%;max-height:600px;height:600px;overflow:hidden;position:relative;display:flex;justify-content:center}.image-wrapper{height:100%;width:100%}#hidden-image{display:none}.text-wrapper ::slotted(*){font-family:HCo Ringside Narrow SSm,Arial Narrow,Arial,sans-serif}.text-wrapper .headline ::slotted(*){font-family:HCo Ringside Narrow SSm,serif}.read-more-link{display:flex;flex-direction:row;justify-content:center;flex-wrap:wrap}.read-more-link ::slotted(.btn),.read-more-link ::slotted(a){font-weight:700!important;vertical-align:middle;touch-action:manipulation;cursor:pointer;border:1px solid transparent;white-space:nowrap;padding:6px 12px;font-size:13px;line-height:1.42857143;border-radius:1px;user-select:none;text-decoration:none!important;min-width:200px;min-height:40px;box-sizing:border-box;display:flex;align-items:center;justify-content:center;margin:5px!important}:host(.title-only){max-height:400px;height:400px}:host(.title-only) .image-wrapper{background-repeat:no-repeat;background-position:50%;background-size:cover}:host(.title-only) .text-wrapper .headline{font-size:200px!important;position:absolute;left:50%;transform:translateX(-50%);bottom:0;line-height:135px;text-transform:uppercase}:host(.title-only) .text-wrapper .headline ::slotted(*){font-family:HCo Ringside Narrow SSm,Arial Narrow,Arial,sans-serif!important;color:var(--hero-text-color,#fff)}:host(.video-hero) .image-wrapper{position:absolute;top:0;left:0;z-index:200}:host(.video-hero) .text-wrapper{color:var(--hero-text-color,#fff);position:absolute;top:0;left:0;width:100%;height:100%;display:flex;flex-direction:column;align-content:center;justify-content:center;text-align:center;box-sizing:border-box;z-index:300}:host(.video-hero) .text-wrapper .text-inner-wrapper{padding:20px}:host(.video-hero) .text-wrapper .headline{font-size:80px;line-height:normal}:host(.video-hero) .text-wrapper .intro-text{margin-top:15px;font-size:18px}:host(.video-hero) .text-wrapper .read-more-link{margin:0 auto;margin-top:50px}:host(.video-hero) .text-wrapper .read-more-link ::slotted(.btn),:host(.video-hero) .text-wrapper .read-more-link ::slotted(a){background-color:var(--read-more-bg-color,#002e5d)!important;color:var(--read-more-color,#fff)!important}:host(.video-hero) .text-wrapper .read-more-link ::slotted(.btn:hover),:host(.video-hero) .text-wrapper .read-more-link ::slotted(a:hover){background-color:var(--read-more-hover-color,#00152a)!important;border-color:var(--read-more-hover-border-color,#000306)!important}:host(.video-hero) #hidden-image{display:inline;position:absolute;z-index:250}:host(.video-hero) .hidden{opacity:0;transition:opacity 2s ease-in-out}:host(.video-hero) .overlay{position:absolute;z-index:400;width:100%;height:100%;background-image:url(\"/byu-hero-banner/dark.png\");background-repeat:repeat;background-size:auto}:host(.video-hero) .tv{position:absolute;top:0;left:0;z-index:100;background-color:#000;width:100%;height:100%;overflow:hidden}:host(.video-hero) .tv .screen{position:absolute;top:0;right:0;bottom:0;left:50%;transform:translateX(-50%);z-index:150;margin:auto;opacity:1;transition:opacity .5s}:host(.video-hero) .tv .screen.active{opacity:1}:host(.full-screen) .image-wrapper{background-size:cover;background-position:50%}:host(.full-screen) .text-wrapper{position:absolute;top:0;left:0;width:100%;height:100%;display:flex;flex-direction:column;align-content:center;justify-content:center;text-align:center;box-sizing:border-box;z-index:300}:host(.full-screen) .text-wrapper .text-inner-wrapper{padding:20px}:host(.full-screen) .text-wrapper .headline{font-size:80px;line-height:normal}:host(.full-screen) .text-wrapper .intro-text{margin-top:15px;font-size:18px}:host(.full-screen) .text-wrapper .read-more-link{margin:0 auto;margin-top:50px}:host(.full-screen) .text-wrapper .read-more-link ::slotted(.btn),:host(.full-screen) .text-wrapper .read-more-link ::slotted(a){background-color:var(--read-more-bg-color,#002e5d)!important;color:var(--read-more-color,#fff)!important}:host(.full-screen) .text-wrapper .read-more-link ::slotted(.btn:hover),:host(.full-screen) .text-wrapper .read-more-link ::slotted(a:hover){background-color:var(--read-more-hover-color,#00152a)!important;border-color:var(--read-more-hover-border-color,#000306)!important}:host(.full-screen.light-image) .text-wrapper .text-inner-wrapper{background-color:var(--text-bg-color,hsla(0,0%,100%,.8))}:host(.full-screen.light-image) .text-wrapper .text-inner-wrapper .headline{color:var(--hero-text-color,#002e5d);font-size:60px;line-height:normal}:host(.full-screen.light-image) .text-wrapper .text-inner-wrapper .intro-text{color:var(--intro-text-color,#002e5d);margin-top:15px;font-size:18px;line-height:30px}:host(.full-screen.light-image) .text-wrapper .text-inner-wrapper .read-more-link{margin-top:20px;align-self:center}:host(.full-screen.light-image) .text-wrapper .text-inner-wrapper .read-more-link ::slotted(.btn),:host(.full-screen.light-image) .text-wrapper .text-inner-wrapper .read-more-link ::slotted(a){background-color:var(--read-more-bg-color,#002e5d)!important;color:var(--read-more-color,#fff)!important}:host(.full-screen.light-image) .text-wrapper .text-inner-wrapper .read-more-link ::slotted(.btn:hover),:host(.full-screen.light-image) .text-wrapper .text-inner-wrapper .read-more-link ::slotted(a:hover){background-color:var(--read-more-hover-color,#00152a)!important;border-color:var(--read-more-hover-border-color,#000306)!important}:host(.full-screen.dark-image) .text-wrapper .text-inner-wrapper{background:inherit}:host(.full-screen.dark-image) .text-wrapper .headline,:host(.full-screen.dark-image) .text-wrapper .intro-text,:host(.full-screen.dark-image) .text-wrapper .read-more-link{color:var(--hero-text-color,#fff)}:host(.full-screen.dark-image) .text-wrapper .read-more-link ::slotted(.btn),:host(.full-screen.dark-image) .text-wrapper .read-more-link ::slotted(a){background-color:var(--read-more-bg-color,#002e5d)!important;color:var(--read-more-color,#fff)!important}:host(.side-image){background-color:initial;display:flex;margin:0 auto;max-width:1200px;padding:0 16px;box-sizing:border-box;height:auto;align-items:center;justify-content:center}:host(.side-image) .image-wrapper{height:414px;width:100%;background-size:contain;background-repeat:no-repeat;background-position:50%}:host(.side-image) .text-wrapper{width:100%;height:100%;display:flex;flex-direction:column;justify-content:center;text-align:left;box-sizing:border-box;margin-left:50px}:host(.side-image) .text-wrapper .headline{color:var(--hero-text-color,#002e5d);font-size:60px;line-height:normal}:host(.side-image) .text-wrapper .intro-text{margin-top:15px;font-size:18px;line-height:30px}:host(.side-image) .text-wrapper .read-more-link{margin:0 -10px;margin-top:20px;justify-content:flex-start}:host(.side-image) .text-wrapper .read-more-link ::slotted(.btn),:host(.side-image) .text-wrapper .read-more-link ::slotted(a){background-color:var(--read-more-bg-color,#002e5d)!important;color:var(--read-more-color,#fff)!important}:host(.side-image) .text-wrapper .read-more-link ::slotted(.btn:hover),:host(.side-image) .text-wrapper .read-more-link ::slotted(a:hover){background-color:var(--read-more-hover-color,#00152a)!important;border-color:var(--read-more-hover-border-color,#000306)!important}:host(.side-image.left-aligned){max-width:100%;display:flex}:host(.side-image.image-style-2){align-items:flex-start;padding:0}@media screen and (max-width:767px){:host(.side-image.image-style-2){flex-wrap:wrap}}:host(.side-image.image-style-2) .image-wrapper,:host(.side-image.image-style-2) .image-wrapper iframe{height:320px;width:100%;max-width:570px;background-position:top}@media screen and (max-width:1024px){:host(.side-image.image-style-2) .image-wrapper,:host(.side-image.image-style-2) .image-wrapper iframe{height:270px;max-width:767px}}@media screen and (width:768px){:host(.side-image.image-style-2) .image-wrapper,:host(.side-image.image-style-2) .image-wrapper iframe{height:180px;max-width:320px}}@media screen and (max-width:767px){:host(.side-image.image-style-2) .image-wrapper,:host(.side-image.image-style-2) .image-wrapper iframe{margin-bottom:20px;margin-right:auto}}:host(.side-image.image-style-2) .image-wrapper .html5-video-player.ad-interrupting,:host(.side-image.image-style-2) .image-wrapper .html5-video-player.ended-mode,:host(.side-image.image-style-2) .image-wrapper .html5-video-player.unstarted-mode,:host(.side-image.image-style-2) .image-wrapper .html5-video-player.ytp-fullscreen,:host(.side-image.image-style-2) .image-wrapper .html5-video-player:not(.ytp-transparent),:host(.side-image.image-style-2) .image-wrapper iframe .html5-video-player.ad-interrupting,:host(.side-image.image-style-2) .image-wrapper iframe .html5-video-player.ended-mode,:host(.side-image.image-style-2) .image-wrapper iframe .html5-video-player.unstarted-mode,:host(.side-image.image-style-2) .image-wrapper iframe .html5-video-player.ytp-fullscreen,:host(.side-image.image-style-2) .image-wrapper iframe .html5-video-player:not(.ytp-transparent){background:#fff}:host(.side-image.image-style-2) .text-wrapper{margin:0 50px;justify-content:flex-start}@media screen and (max-width:1024px){:host(.side-image.image-style-2) .text-wrapper{margin:0 30px}}@media screen and (max-width:768px){:host(.side-image.image-style-2) .text-wrapper{margin:0 20px}}:host(.side-image.image-style-2) .text-wrapper .text-inner-wrapper .headline{font-size:30px;font-weight:500}@media screen and (max-width:1024px){:host(.side-image.image-style-2) .text-wrapper .text-inner-wrapper .headline{font-size:25px;line-height:35px}}:host(.side-image.image-style-2) .text-wrapper .intro-text{margin-top:10px}:host(.side-image.image-style-2) .text-wrapper .read-more-link{margin:0}:host(.side-image.image-style-2) #hidden-image{display:none!important}:host(.transparent-overlay) .image-wrapper{width:100%;height:100%;background-size:cover;background-position:50%}:host(.transparent-overlay) .text-wrapper{height:100%;width:1200px;margin:0 auto;padding:0 16px;box-sizing:border-box;display:flex;justify-content:flex-start;position:absolute;top:0;left:50%;margin-left:-600px}:host(.transparent-overlay) .text-wrapper .text-inner-wrapper{width:400px;height:80%;transform:translateY(10%);background-color:var(--text-bg-color,hsla(0,0%,100%,.8));padding:0 30px;display:flex;flex-direction:column;justify-content:center;text-align:left;box-sizing:border-box}:host(.transparent-overlay) .text-wrapper .headline{color:var(--hero-text-color,#002e5d);font-size:60px;line-height:normal}:host(.transparent-overlay) .text-wrapper .intro-text{margin-top:15px;font-size:18px;line-height:30px}:host(.transparent-overlay) .text-wrapper .read-more-link{margin-top:20px;align-self:center;width:100%}:host(.transparent-overlay) .text-wrapper .read-more-link ::slotted(.btn),:host(.transparent-overlay) .text-wrapper .read-more-link ::slotted(a){background-color:var(--read-more-bg-color,#002e5d)!important;color:var(--read-more-color,#fff)!important}:host(.transparent-overlay) .text-wrapper .read-more-link ::slotted(.btn:hover),:host(.transparent-overlay) .text-wrapper .read-more-link ::slotted(a:hover){background-color:var(--read-more-hover-color,#00152a)!important;border-color:var(--read-more-hover-border-color,#000306)!important}:host(.transparent-overlay.byu-hero-right) .text-wrapper,:host(.transparent-overlay.right) .text-wrapper{justify-content:flex-end}@media (max-width:1440px){:host(.title-only){max-height:320px}:host(.title-only) .text-wrapper .headline{font-size:160px!important;line-height:108px}}@media (max-width:1232px){:host(.title-only){max-height:280px}:host(.title-only) .text-wrapper .headline{font-size:130px!important;line-height:88px}:host(.transparent-overlay) .text-wrapper{width:100%;left:0;margin-left:0}}@media (max-width:1024px){:host(.title-only){max-height:220px}:host(.title-only) .text-wrapper .headline{font-size:98px!important;line-height:66px}:host(.full-screen){height:768px}:host(.full-screen) .text-wrapper .text-inner-wrapper .headline{font-size:55px;line-height:60px}:host(.full-screen) .text-wrapper .text-inner-wrapper .intro-text{font-size:16px}:host(.side-image) .image-wrapper{height:216px}:host(.side-image) .text-wrapper .text-inner-wrapper .headline{font-size:35px;line-height:37px}:host(.side-image) .text-wrapper .text-inner-wrapper .intro-text{font-size:14px;line-height:22px}:host(.transparent-overlay){height:768px}:host(.transparent-overlay) .text-wrapper{height:auto;max-width:100%;width:100%;padding:0;position:absolute;top:inherit;bottom:0;left:0}:host(.transparent-overlay) .text-wrapper .text-inner-wrapper{width:100%;padding:30px;transform:none}:host(.transparent-overlay) .text-wrapper .text-inner-wrapper .headline{font-size:35px;line-height:37px}:host(.transparent-overlay) .text-wrapper .text-inner-wrapper .intro-text{font-size:14px;line-height:22px}}@media (max-width:768px){:host(.title-only){max-height:190px}:host(.title-only) .text-wrapper .headline{font-size:78px!important;line-height:52px}}@media (max-width:616px){.text-wrapper .headline,:host(.video-hero) .text-wrapper .headline{font-size:55px}:host(.title-only){max-height:120px}:host(.side-image){height:auto;max-height:none;padding:0;display:block}:host(.side-image) .image-wrapper{background:none;height:auto}:host(.side-image) .image-wrapper #hidden-image{display:block;width:100%}:host(.side-image) .text-wrapper{margin-top:20px;margin-left:0;height:auto;padding:0 20px}:host(.side-image) .text-wrapper .read-more-link{margin-top:20px}}:host(.side-image) .text-wrapper .read-more-link ::slotted(.no-button),:host(.side-image) .text-wrapper .read-more-link ::slotted(.no-button:hover){background:none!important;font-weight:400!important;font-size:15px;font-style:italic;color:var(--read-more-color,#0057b8)!important;border:none;padding:0;align-items:flex-start;justify-content:flex-start;margin:5px 0!important}:host(.side-image) .text-wrapper .read-more-link ::slotted(.no-button:hover){color:var(--read-more-hover-color,#002e5d)}", ""]);
...
/***/function (module, exports, __webpack_require__) {
  ...
  module.exports = "<style>" + __webpack_require__(7) + "</style> <div class=\"image-wrapper\"> <div class=\"overlay\"></div> <img class=\"hidden-image\" id=\"hidden-image\"> <div class=\"tv\"> <div id=\"player\" class=\"screen mute\"></div> </div> </div> <div class=\"text-wrapper\"> <div class=\"text-inner-wrapper\"> <div class=\"headline slot-wrapper\"> <slot id=\"headline\" name=\"headline\"></slot> </div> <div class=\"intro-text slot-wrapper\"> <slot id=\"intro-text\" name=\"intro-text\"></slot> </div> <div class=\"read-more-link slot-wrapper\"> <slot id=\"read-more\" name=\"read-more\"></slot> </div> </div> </div>";
